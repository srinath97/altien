  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-folder"></i> <b>Files</b></h3>
				</div>
			</div>
                <?php
                require_once("db.php");
                $quer1="SELECT * FROM posts WHERE dept='$dept' and sem='$sem' and section='$sec' and image=false and file!='' ORDER BY id desc";
                            ...
                            <div class="col-lg-8" style="background-color:#111;padding:15px;margin-left:15px">
                                ...
                                if($r2=mysqli_fetch_array($resul2))
                                {
                                    ...
                                    <?php
                                        ...
                                        {
                                            ?>
                                            <img style="width:100%;height:100%" src="files/<?php echo $r1['temp'];?>" >
                                            <?php
                                        }
                                        else if($r1['file']!="")
                                        {
