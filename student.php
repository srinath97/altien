...
<html lang="en">
  ...
  #progress-div {border:#0FA015 1px solid;padding: 5px 0px; width: 10%; border-radius:4px;}
  ...
  <section id="container" class="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-laptop"></i> <b>Dashboard</b></h3>
        </div>
      </div>
      <div class="row">
                <!-- profile-widget -->
                <div class="col-lg-12">
                    <form class="form-horizontal" id="uploadForm" enctype="multipart/form-data" role="form" action="upload.php" method="post">                                                  
                        <div class="form-group">
                            <div class="col-lg-8" style="background-color:#123;padding:15px;margin-left:30px">
                                <textarea required class="form-control" name="content" style="height:100px;width:100%;resize:none" placeholder="Write something here..."></textarea>
                                <br>
                                <div class="form-group">
                                    <div class="col-lg-offset-0 col-lg-13">
                                        <input style="margin-left:15px;width:30%;float:left;" class="form-control" type="file" id="img" name="file" autocomplete="off" class="demoInputBox">
                                        <input hidden name="regno" value="<?php echo $regno?>" />
                                        <input hidden name="dept" value="<?php echo $dept?>" />
                                        <input hidden name="sec" value="<?php echo $sec?>" />
                                        <input hidden name="sem" value="<?php echo $sem?>" />
                                        <input type="submit" style="width:150px;float:right;margin-right:15px" id="btnSubmit" value="Submit" class="btnSubmit" />
                                        <div hidden="true" style="width:300px;float:left;margin-left:20px" id="progress-div"><div style="margin:5px;margin-right:10px" id="progress-bar"></div></div>
                                    </div>
                                </div>
                ...
                <?php
                require_once("db.php");
                $quer1="SELECT * FROM posts WHERE dept='$dept' and sem='$sem' and section='$sec' ORDER BY id desc";
              ...
              if($x==0)
              {
                  ?><h2 style="color:black;margin-left:30px"> No Posts Found. Be The First to Post in your section...</h2>
              <?php
            }?>
