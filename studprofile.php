                    ...
                    <div class="profile-widget profile-widget-info">
                          <div class="panel-body" style="background:#123;">
                            <div class="col-lg-3 col-sm-2">
                              <h3 style="font-family:Times;"><?php echo $row['name']; ?></h4>               
                              <div class="follow-ava">
                                  <img style="height:100%;width:100%;" src="img/student/<?php echo $img?>" alt="">
                              </div>
                              <h4 style="font-family:Times;"><?php echo "Student"?></h6>
                            </div>
                            <div class="col-lg-8 col-sm-2 follow-info" style="margin-left:50px;">
                                 <div style="font-size:18px;">
                                      <h1 style="font-family:Times;">About Me</h1>
                                                <?php echo $row['about'];?>
                                      </div>
                                      <div class="">
                                          ...
                                          <div class="row">
                                              <div class="bio-row">
                                                  <p><span><b>Name </b></span>: <?php echo $row['name'] ?> </p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span><b>Nick Name </b></span>: <?php echo $row['nickname']; ?></p>
                                              </div>                                              
                                              <div class="bio-row">
                                                  <p><span><b>Register No.</b></span>: <?php echo $row['regno']; ?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span><b>Semester </b></span>: <?php echo $row['sem']; ?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span><b>Department </b></span>: <?php echo $row['department']; ?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span><b>Email </b></span>: <?php echo $row['email']; ?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span><b>Section </b></span>: <?php echo $row['section']; ?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span><b>Roll No </b></span>:  <?php echo $row['rollno']; ?></p>
                                              </div>
                                          </div>
                                      </div>
                                </div>
